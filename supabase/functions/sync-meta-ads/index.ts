  ...
  try {
    ...
    const factRows = insights.map((ins: any) => {
      ...
      const row: any = {
        ...
        creative_id: null,
        placement: ins.publisher_platform && ins.platform_position ? `${ins.publisher_platform}_${ins.platform_position}` : null,
        device_platform: ins.device_platform || null,
        publisher_platform: ins.publisher_platform || null,
        age: ins.age || null,
        gender: ins.gender || null,
        country: ins.country || null,
        spend,
        impressions,
        reach,
        clicks,
